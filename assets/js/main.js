...
function usersearch(){
        ...
        $.ajax({ 
    type: 'GET',
    url: 'http://34118b73b70d.ngrok.io/users',
    data: 'user='+value, 
    headers:{
        'Authorization':'Bearer '+token,
        'Content-Type': 'application/json'
...
function addmoney(arr){
    ...
    $.ajax({ 
    type: 'PUT',
    url: 'http://34118b73b70d.ngrok.io/walletoptions',
    data: JSON.stringify(arr), 
    headers:{
        'Authorization':'Bearer '+token,
        'Content-Type': 'application/json'
...
function addproduct(){
    ...
    $.ajax({ 
    type: 'POST',
    url: 'http://34118b73b70d.ngrok.io/products',
    data: JSON.stringify(arr), 
    headers:{
        'Authorization':'Bearer '+token,
        'Content-Type': 'application/json'
...
function displayorders(date){
    ...
    $.ajax({ 
    type: 'GET',
    url: 'http://34118b73b70d.ngrok.io/orders', 
    data: 'date='+todaydate,
    headers:{
        'Authorization':'Bearer '+token,
        'Content-Type': 'application/json'
...
function displaychart(date){
    ...
    $.ajax({ 
    type: 'GET',
    url: 'http://34118b73b70d.ngrok.io/sales', 
    data: 'date='+date,
    headers:{
        'Authorization':'Bearer '+token,
        'Content-Type': 'application/json'
...
$.ajax({ 
    type: 'GET',
    url: 'http://34118b73b70d.ngrok.io/weeksales', 
    data: 'date='+date,
    headers:{
        'Authorization':'Bearer '+token,
        'Content-Type': 'application/json'
...
$.ajax({ 
    type: 'GET',
    url: 'http://34118b73b70d.ngrok.io/monthsales', 
    data: 'date='+date,
    headers:{
        'Authorization':'Bearer '+token,
        'Content-Type': 'application/json'
...
function report(){
    ...
    $.ajax({ 
    type: 'GET',
    url: 'http://34118b73b70d.ngrok.io/report',
    headers:{
        'Authorization':'Bearer '+token
    },
    success: function(response){ 
...
function displaytransactions(date){
    ...
    $.ajax({ 
    type: 'GET',
    url: 'http://34118b73b70d.ngrok.io/transactions', 
    data: 'date='+todaydate,
    headers:{
        'Authorization':'Bearer '+token,
        'Content-Type': 'application/json'
